...
namespace Quantum {
  ...
  public unsafe partial struct Input {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + MassAdjustment.GetHashCode();
    ...
    static partial void SerializeCodeGen(void* ptr, FrameSerializer serializer) {
        ...
        FP.Serialize(&p->MassAdjustment, serializer);
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Ex2TeamGameplay : Quantum.IComponentSingleton {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 12473;
        hash = hash * 31 + PreTransitionTime.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Ex2TeamGameplay*)ptr;
        PlayerRef.Serialize(&p->Winner, serializer);
        FP.Serialize(&p->PreTransitionTime, serializer);
  ...
  public unsafe partial struct FinishTrigger : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + RequireAllPlayers.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (FinishTrigger*)ptr;
        QBoolean.Serialize(&p->RequireAllPlayers, serializer);
        AssetRef.Serialize(&p->TargetMap, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerInTrigger : Quantum.IComponent {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    [ExcludeFromPrototype()]
    public EntityRef CurrentTrigger;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 16883;
        hash = hash * 31 + CurrentTrigger.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerInTrigger*)ptr;
        EntityRef.Serialize(&p->CurrentTrigger, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerInteractionState : Quantum.IComponent {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    [ExcludeFromPrototype()]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 10861;
        hash = hash * 31 + CubeEntity.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerInteractionState*)ptr;
        EntityRef.Serialize(&p->CubeEntity, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PushableObject : Quantum.IComponent {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 1229;
        hash = hash * 31 + CurrentMass.GetHashCode();
        hash = hash * 31 + MinMass.GetHashCode();
        hash = hash * 31 + MaxMass.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PushableObject*)ptr;
        FP.Serialize(&p->CurrentMass, serializer);
        FP.Serialize(&p->MaxMass, serializer);
        FP.Serialize(&p->MinMass, serializer);
    }
  }
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.Ex2TeamGameplay>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Ex2TeamGameplay>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerInTrigger>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerInTrigger>();
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerInteractionState>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerInteractionState>();
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerLink>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerLink>();
      BuildSignalsArrayOnComponentAdded<Quantum.PushableObject>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PushableObject>();
    ...
    partial void SetPlayerInputCodeGen(PlayerRef player, Input input) {
      ...
      i->MassAdjustment = input.MassAdjustment;
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.Ex2TeamGameplay), Quantum.Ex2TeamGameplay.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.PlayerInTrigger), Quantum.PlayerInTrigger.SIZE);
      typeRegistry.Register(typeof(Quantum.PlayerInteractionState), Quantum.PlayerInteractionState.SIZE);
      typeRegistry.Register(typeof(Quantum.PlayerLink), Quantum.PlayerLink.SIZE);
      typeRegistry.Register(typeof(PlayerRef), PlayerRef.SIZE);
      typeRegistry.Register(typeof(Ptr), Ptr.SIZE);
      typeRegistry.Register(typeof(Quantum.PushableObject), Quantum.PushableObject.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 6)
        ...
        .Add<Quantum.Ex2TeamGameplay>(Quantum.Ex2TeamGameplay.Serialize, null, null, ComponentFlags.Singleton)
        .Add<Quantum.FinishTrigger>(Quantum.FinishTrigger.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerInTrigger>(Quantum.PlayerInTrigger.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerInteractionState>(Quantum.PlayerInteractionState.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerLink>(Quantum.PlayerLink.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PushableObject>(Quantum.PushableObject.Serialize, null, null, ComponentFlags.None)
        .Finish();
    }
    [Preserve()]
